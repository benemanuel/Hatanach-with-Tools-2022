    ...
    books = [
      {
        ...
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*(?:[ei]\.?[\s\xa0]*Samuelit|Sam(?:uelit)?)|\.[\s\xa0]*Samuelit|Sam)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*(?:[ei]\.?[\s\xa0]*Samuelit|Sam(?:uelit)?)|\.[\s\xa0]*Samuelit|Sam)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*(?:[ei](?:\.[\s\xa0]*Mbret[e\xEB]|[\s\xa0]*Mbret[e\xEB])rve|Mb(?:ret[e\xEB]rve)?)|\.[\s\xa0]*Mbret[e\xEB]rve|Kgs)|4(?:[\s\xa0]*[ei](?:\.[\s\xa0]*Mbret[e\xEB]|[\s\xa0]*Mbret[e\xEB])|\.[\s\xa0]*Mbret[e\xEB]|[\s\xa0]*Mbret[e\xEB])rve))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*(?:[ei](?:\.[\s\xa0]*Mbret[e\xEB]|[\s\xa0]*Mbret[e\xEB])rve|Mb(?:ret[e\xEB]rve)?)|\.[\s\xa0]*Mbret[e\xEB]rve|Kgs)|3(?:[\s\xa0]*[ei](?:\.[\s\xa0]*Mbret[e\xEB]|[\s\xa0]*Mbret[e\xEB])|\.[\s\xa0]*Mbret[e\xEB]|[\s\xa0]*Mbret[e\xEB])rve))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*(?:[ei](?:\.[\s\xa0]*Kronika(?:ve)?|[\s\xa0]*Kronika(?:ve)?)|Kr(?:onika(?:ve)?)?)|\.[\s\xa0]*Kronika(?:ve)?|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*(?:[ei](?:\.[\s\xa0]*Kronika(?:ve)?|[\s\xa0]*Kronika(?:ve)?)|Kr(?:onika(?:ve)?)?)|\.[\s\xa0]*Kronika(?:ve)?|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        ...
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*(?:[ei]\.?[\s\xa0]*Gjonit|Gj(?:onit)?)|\.[\s\xa0]*Gjonit|John)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*(?:[ei]\.?[\s\xa0]*Gjonit|Gj(?:onit)?)|\.[\s\xa0]*Gjonit|John)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:3(?:[\s\xa0]*(?:[ei]\.?[\s\xa0]*Gjonit|Gj(?:onit)?)|\.[\s\xa0]*Gjonit|John)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        ...
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*(?:[ei](?:\.[\s\xa0]*Korin?|[\s\xa0]*Korin?)tasve|Kor(?:in?tasve)?)|\.[\s\xa0]*Korin?tasve|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*(?:[ei](?:\.[\s\xa0]*Korin?|[\s\xa0]*Korin?)tasve|Kor(?:in?tasve)?)|\.[\s\xa0]*Korin?tasve|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Gal"],
        ...
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Thesalonikasve|Thess))|(?:2(?:[\s\xa0]*(?:[ei](?:\.[\s\xa0]*(?:Thesalo|Sela)|[\s\xa0]*(?:Thesalo|Sela))nikasve|Selanikasve|Th)|\.[\s\xa0]*(?:Thesalo|Sela)nikasve)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Thesalonikasve|Thess))|(?:1(?:[\s\xa0]*(?:[ei](?:\.[\s\xa0]*(?:Thesalo|Sela)|[\s\xa0]*(?:Thesalo|Sela))nikasve|Selanikasve|Th)|\.[\s\xa0]*(?:Thesalo|Sela)nikasve)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*(?:[ei]\.?[\s\xa0]*Timoteut|Tim(?:oteut)?)|\.[\s\xa0]*Timoteut|Tim)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*(?:[ei]\.?[\s\xa0]*Timoteut|Tim(?:oteut)?)|\.[\s\xa0]*Timoteut|Tim)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Titus"],
        ...
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*(?:Pj(?:etrit|e)?|[ei]\.?[\s\xa0]*Pjetrit)|(?:\.[\s\xa0]*Pjetri|Pe)t)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*(?:Pj(?:etrit|e)?|[ei]\.?[\s\xa0]*Pjetrit)|(?:\.[\s\xa0]*Pjetri|Pe)t)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Jude"],
