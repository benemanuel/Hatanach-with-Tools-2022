(function() {
  ...
  bcv_parser.prototype.regexps.escaped_passage = /(?:^|[^\x1f\x1e\dA-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014]|ba[??s]l[??Ii??]k(?![a-z])|baplar|ayeti|ayet|bap|ile|a\.|bp|vs|vd|ve|[b-e](?!\w)|$)+)/gi;

  bcv_parser.prototype.regexps.match_end_split = /\d\W*ba[??s]l[??Ii??]k|\d\W*(?:vs|vd)(?:[\s\xa0*]*\.)?|\d[\s\xa0*]*[b-e](?!\w)|\x1e(?:[\s\xa0*]*[)\]\uff09])?|[\d\x1f]/gi;

  bcv_parser.prototype.regexps.control = /[\x1e\x1f]/g;

  bcv_parser.prototype.regexps.pre_book = "[^A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???]";

  bcv_parser.prototype.regexps.first = "(?:1|I|Bir|Birinci|[??Ii??]lk)\\.?" + bcv_parser.prototype.regexps.space + "*";

  bcv_parser.prototype.regexps.second = "(?:2|II|[??Ii??]ki|[??Ii??]kinci)\\.?" + bcv_parser.prototype.regexps.space + "*";

  bcv_parser.prototype.regexps.third = "(?:3|III|[??U][??c]|[??U][??c][??u]nc[??u])\\.?" + bcv_parser.prototype.regexps.space + "*";
    ...
    books = [
      {
        ...
        osis: ["Gen"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Te(?:sn[I????]ye|kv[I????]n)|Gen|Yar(?:at[I????]l[I????][s??])?)|(?:Yarat(?:il[Ii????][s??]|[I????]li[s??])|Te(?:sniye|kvin)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Exod"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:M[I????]s[I????]r(?:['???]dan[\\s\\xa0]*[C\\xC7][I????]k[I????][s??]|dan[\\s\\xa0]*[C\\xC7][I????]k[I????][s??])|[C\\xC7][I????]k|Exod)|(?:M(?:[I????]s(?:[I????]r(?:['???]dan[\\s\\xa0]*[C\\xC7](?:ik[Ii????][s??]|[I????]ki[s??])|dan[\\s\\xa0]*[C\\xC7](?:ik[Ii????][s??]|[I????]ki[s??]))|ir(?:['???]dan[\\s\\xa0]*[C\\xC7][Ii????]|dan[\\s\\xa0]*[C\\xC7][Ii????])k[Ii????][s??])|is[Ii????]r(?:['???]dan[\\s\\xa0]*[C\\xC7][Ii????]|dan[\\s\\xa0]*[C\\xC7][Ii????])k[Ii????][s??])|[C\\xC7]ik[Ii????][s??]|[C\\xC7]ik|[C\\xC7][I????]k[Ii????][s??]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Bel"],
        apocrypha: true,
        ...
        osis: ["Lev"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Lev(?:[Ii????]l[Ii????]ler)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Num"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:[C\\xC7][o\\xF6]lde[\\s\\xa0]*Say[I????]m|Say(?:[I????]lar)?|Num)|(?:[C\\xC7][o\\xF6]lde[\\s\\xa0]*Sayim|Sayilar))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Sir"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:S(?:ir(?:ak)?|[I????]rak)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Wis"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:B[Ii????]lgelik|Wis))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Lam"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:A[g??][Ii????](?:tlar)?|Lam))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["EpJer"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Yeremya(?:['???]n[Ii????]|n[Ii????])n[\\s\\xa0]*Mektubu|EpJer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rev"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Va(?:h(?:[Ii????]y)?)?|Rev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["PrMan"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Mana[s??][s??]e(?:['???]n[I????]n[\\s\\xa0]*Duas[I????]|n[I????]n[\\s\\xa0]*Duas[I????])|PrMan)|(?:Mana[s??][s??]e(?:['???]n(?:in[\\s\\xa0]*Duas[Ii????]|[I????]n[\\s\\xa0]*Duasi)|n(?:in[\\s\\xa0]*Duas[Ii????]|[I????]n[\\s\\xa0]*Duasi))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Deut"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Yas(?:a(?:['???]n[I????]n[\\s\\xa0]*Tekrar[I????]|n[I????]n[\\s\\xa0]*Tekrar[I????]))?|Deut)|(?:Yasa(?:['???]n(?:in[\\s\\xa0]*Tekrar[Ii????]|[I????]n[\\s\\xa0]*Tekrari)|n(?:in[\\s\\xa0]*Tekrar[Ii????]|[I????]n[\\s\\xa0]*Tekrari))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Josh"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Y(?:e[s??]|[s??])u|Josh))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Judg"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Hak(?:[Ii????]mler)?|Judg))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ruth"],
        ...
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:[i????]lk|1\.|I(?:lk|\.))[\s\xa0]*Esdras|[1I][\s\xa0]*Esdras|1Esd|Bir(?:inci)?[\s\xa0]*Esdras))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Esdras|Esd|\.[\s\xa0]*Esdras)|[i????]ki(?:nci)?[\s\xa0]*Esdras|I(?:ki(?:nci)?|I\.?)[\s\xa0]*Esdras))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Isa"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:(?:Y(?:e[s??]ay|[s??])|Is)a))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Samuel|Sam|\.[\s\xa0]*Samuel))|(?:[i????]ki(?:nci)?[\s\xa0]*Samuel|2(?:\.[\s\xa0]*|[\s\xa0]*)?Sa|I(?:ki(?:nci)?|I\.?)[\s\xa0]*Samuel))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Samuel|Sam|\.[\s\xa0]*Samuel))|(?:(?:I(?:lk|\.)|[i????]lk)[\s\xa0]*Samuel|1(?:\.[\s\xa0]*|[\s\xa0]*)?Sa|I[\s\xa0]*Samuel|Bir(?:inci)?[\s\xa0]*Samuel))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2\.?[\s\xa0]*Krallar)|(?:[i????]ki(?:nci)?[\s\xa0]*Krallar|2(?:K(?:gs|r)|\.?[\s\xa0]*Kr)|I(?:ki(?:nci)?|I\.?)[\s\xa0]*Krallar))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1\.?[\s\xa0]*Krallar)|(?:1(?:K(?:gs|r)|\.?[\s\xa0]*Kr)|I[\s\xa0]*Krallar|(?:I(?:lk|\.)|[i????]lk)[\s\xa0]*Krallar|Bir(?:inci)?[\s\xa0]*Krallar))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:[????]ki(?:nci[\s\xa0]*Tar[I????]|[\s\xa0]*Tar[I????])hler|2(?:\.?[\s\xa0]*Tar[I????]hler|(?:\.?[\s\xa0]*)?Ta|Chr)|I(?:ki(?:nci[\s\xa0]*Tar[I????]|[\s\xa0]*Tar[I????])|I(?:\.[\s\xa0]*Tar[I????]|[\s\xa0]*Tar[I????]))hler)|(?:(?:(?:(?:II|2)\.|II|2|Iki(?:nci)?|[????]ki(?:nci)?)[\s\xa0]*Tari|iki(?:nci[\s\xa0]*Tar[Ii????]|[\s\xa0]*Tar[Ii????]))hler))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:\.?[\s\xa0]*Tar[I????]hler|(?:\.?[\s\xa0]*)?Ta|Chr)|I[\s\xa0]*Tar[I????]hler|(?:I(?:lk|\.)|[????]lk)[\s\xa0]*Tar[I????]hler|Bir(?:inci[\s\xa0]*Tar[I????]|[\s\xa0]*Tar[I????])hler)|(?:(?:(?:I(?:lk|\.)|[????]lk|1\.)[\s\xa0]*Tari|ilk[\s\xa0]*Tar[Ii????]|[1I][\s\xa0]*Tari|Bir(?:inci)?[\s\xa0]*Tari)hler))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        ...
        osis: ["PrAzar"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Azarya(?:['???]n[I????]n[\\s\\xa0]*Duas[I????]|n[I????]n[\\s\\xa0]*Duas[I????])|PrAzar)|(?:Azarya(?:['???]n(?:in[\\s\\xa0]*Duas[Ii????]|[I????]n[\\s\\xa0]*Duasi)|n(?:in[\\s\\xa0]*Duas[Ii????]|[I????]n[\\s\\xa0]*Duasi))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Prov"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:S[u\\xFC]leyman(?:['???][I????]n[\\s\\xa0]*(?:[O\\xD6]zdey[I????][s??]ler[I????]|Meseller[I????])|[I????]n[\\s\\xa0]*(?:[O\\xD6]zdey[I????][s??]ler[I????]|Meseller[I????]))|[O\\xD6]zd|Prov|Meseller)|(?:S[u\\xFC]leyman(?:['???](?:[I????]n[\\s\\xa0]*(?:[O\\xD6]zdey(?:i[s??]ler[Ii????]|[I????][s??]leri)|Meselleri)|in[\\s\\xa0]*(?:[O\\xD6]zdey[Ii????][s??]ler[Ii????]|Meseller[Ii????]))|[I????]n[\\s\\xa0]*(?:[O\\xD6]zdey(?:i[s??]ler[Ii????]|[I????][s??]leri)|Meselleri)|in[\\s\\xa0]*(?:[O\\xD6]zdey[Ii????][s??]ler[Ii????]|Meseller[Ii????]))))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eccl"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Va(?:[Ii????]z|[Ii????])|Eccl))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["SgThree"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:[U\\xDC][c\\xE7][\\s\\xa0]*Gen[c\\xE7][\\s\\xa0]*Adam[I????]n[\\s\\xa0]*Ezg[I????]s[I????]|SgThree)|(?:[U\\xDC][c\\xE7][\\s\\xa0]*Gen[c\\xE7][\\s\\xa0]*Adam(?:[I????]n[\\s\\xa0]*Ezgis[Ii????]|[I????]n[\\s\\xa0]*Ezg[I????]si|in[\\s\\xa0]*Ezg[Ii????]s[Ii????])))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Song"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ezg(?:[I????]ler[\\s\\xa0]*Ezg[I????]s[I????])?|Song)|(?:Ezg(?:[I????]ler[\\s\\xa0]*Ezgis[Ii????]|[I????]ler[\\s\\xa0]*Ezg[I????]si|iler[\\s\\xa0]*Ezg[Ii????]s[Ii????])))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jer"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Yer(?:emya)?|Jer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ezek"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Hez(?:ek[Ii????]el)?|Ezek))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Dan"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Dan(?:[Ii????]el)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hos"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ho(?:s(?:ea)?|??)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Joel"],
        ...
        osis: ["Mic"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:M(?:i(?:ka?|c)|[I????]ka?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Nah"],
        ...
        osis: ["Zech"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ze(?:k(?:er[Ii????]ya)?|ch)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Mal(?:ak[Ii????])?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Matt"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Mat(?:t(?:a(?:(?:[I????]n[\\s\\xa0]*[I????]|[I????]|un[\\s\\xa0]*[I????]|n[Iu????]n[\\s\\xa0]*[I????])ncili|a[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*[I????]ncil|ya[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*[I????]ncil|['???](?:(?:n[Iu????]n[\\s\\xa0]*[I????]|[Iu????]n[\\s\\xa0]*[I????])ncili|a[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*[I????]ncil|ya[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*[I????]ncil)))?)?)|(?:Matta(?:['???](?:(?:n(?:[Iu????]n[\\s\\xa0]*i|in[\\s\\xa0]*[Ii????])|[Iu????]n[\\s\\xa0]*i|in[\\s\\xa0]*[Ii????])ncili|a[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*incil|ya[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*incil)|(?:(?:[Iu????]n[\\s\\xa0]*)?i|in[\\s\\xa0]*[Ii????]|n(?:[Iu????]n[\\s\\xa0]*i|in[\\s\\xa0]*[Ii????]))ncili|a[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*incil|ya[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*incil)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mark"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Mar(?:k(?:os(?:(?:[I????]n[\\s\\xa0]*[I????]|[I????]|un[\\s\\xa0]*[I????]|n[Iu????]n[\\s\\xa0]*[I????])ncili|a[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*[I????]ncil|ya[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*[I????]ncil|['???](?:(?:n[Iu????]n[\\s\\xa0]*[I????]|[Iu????]n[\\s\\xa0]*[I????])ncili|a[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*[I????]ncil|ya[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*[I????]ncil)))?)?)|(?:Markos(?:['???](?:(?:n(?:[Iu????]n[\\s\\xa0]*i|in[\\s\\xa0]*[Ii????])|[Iu????]n[\\s\\xa0]*i|in[\\s\\xa0]*[Ii????])ncili|a[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*incil|ya[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*incil)|(?:(?:[Iu????]n[\\s\\xa0]*)?i|in[\\s\\xa0]*[Ii????]|n(?:[Iu????]n[\\s\\xa0]*i|in[\\s\\xa0]*[Ii????]))ncili|a[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*incil|ya[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*incil)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Luke"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Luk(?:a(?:(?:[I????]n[\\s\\xa0]*[I????]|[I????]|un[\\s\\xa0]*[I????]|n[Iu????]n[\\s\\xa0]*[I????])ncili|a[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*[I????]ncil|ya[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*[I????]ncil|['???](?:(?:n[Iu????]n[\\s\\xa0]*[I????]|[Iu????]n[\\s\\xa0]*[I????])ncili|a[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*[I????]ncil|ya[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*[I????]ncil))|e)?)|(?:Luka(?:['???](?:(?:n(?:[Iu????]n[\\s\\xa0]*i|in[\\s\\xa0]*[Ii????])|[Iu????]n[\\s\\xa0]*i|in[\\s\\xa0]*[Ii????])ncili|a[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*incil|ya[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*incil)|(?:in(?:[\\s\\xa0]*[Ii????]n)?|[Iu????]n[\\s\\xa0]*in|n(?:[Iu????]n[\\s\\xa0]*i|in[\\s\\xa0]*[Ii????])n)cili|a[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*incil|ya[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*incil)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1\.?[\s\xa0]*Yuhanna)|(?:1(?:John|Yu|[\s\xa0]*Yu|\.[\s\xa0]*Yu)|I[\s\xa0]*Yuhanna|(?:I(?:lk|\.)|[i????]lk)[\s\xa0]*Yuhanna|Bir(?:inci)?[\s\xa0]*Yuhanna))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2\.?[\s\xa0]*Yuhanna)|(?:[i????]ki(?:nci)?[\s\xa0]*Yuhanna|2(?:John|Yu|[\s\xa0]*Yu|\.[\s\xa0]*Yu)|I(?:ki(?:nci)?|I\.?)[\s\xa0]*Yuhanna))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:3\.?[\s\xa0]*Yuhanna)|(?:3(?:John|Yu|[\s\xa0]*Yu|\.[\s\xa0]*Yu)|III[\s\xa0]*Yuhanna|III\.[\s\xa0]*Yuhanna|[U\xDC][c\xE7](?:[u\xFC]nc[u\xFC])?[\s\xa0]*Yuhanna))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Yu(?:h(?:anna(?:(?:[I????]n[\\s\\xa0]*[I????]|[I????]|un[\\s\\xa0]*[I????]|n[Iu????]n[\\s\\xa0]*[I????])ncili|a[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*[I????]ncil|ya[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*[I????]ncil|['???](?:(?:n[Iu????]n[\\s\\xa0]*[I????]|[Iu????]n[\\s\\xa0]*[I????])ncili|a[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*[I????]ncil|ya[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*[I????]ncil)))?)?|John)|(?:Yuhanna(?:['???](?:(?:n(?:[Iu????]n[\\s\\xa0]*i|in[\\s\\xa0]*[Ii????])|[Iu????]n[\\s\\xa0]*i|in[\\s\\xa0]*[Ii????])ncili|a[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*incil|ya[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*incil)|(?:in(?:[\\s\\xa0]*[Ii????]n)?|[Iu????]n[\\s\\xa0]*in|n(?:[Iu????]n[\\s\\xa0]*i|in[\\s\\xa0]*[Ii????])n)cili|a[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*incil|ya[\\s\\xa0]*G[o\\xF6]re[\\s\\xa0]*incil)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Acts"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:El[c\\xE7](?:[I????]ler[I????]n[\\s\\xa0]*[I????][s??]ler[I????])?|Acts)|(?:El[c\\xE7](?:[I????]ler[I????]n[\\s\\xa0]*i[s??]ler[Ii????]|[I????]ler[I????]n[\\s\\xa0]*[I????][s??]leri|[I????]lerin[\\s\\xa0]*[Ii????][s??]ler[Ii????]|iler[Ii????]n[\\s\\xa0]*[Ii????][s??]ler[Ii????])))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rom"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Rom(?:al[Ii????]lar)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:I(?:ki(?:nci[\s\xa0]*Kor[I????]nt(?:l[I????]le|oslula)|[\s\xa0]*Kor[I????]nt(?:l[I????]le|oslula))|I(?:\.[\s\xa0]*Kor[I????]nt(?:l[I????]le|oslula)|[\s\xa0]*Kor[I????]nt(?:l[I????]le|oslula)))r|[????]ki(?:nci[\s\xa0]*Kor[I????]nt(?:l[I????]le|oslula)|[\s\xa0]*Kor[I????]nt(?:l[I????]le|oslula))r|2(?:\.?[\s\xa0]*Kor[I????]nt(?:l[I????]le|oslula)r|(?:\.?[\s\xa0]*)?Ko|Cor))|(?:(?:(?:(?:II|2)\.[\s\xa0]*Kor[I????]|(?:II|2)[\s\xa0]*Kor[I????]|Iki(?:nci[\s\xa0]*Kor[I????]|[\s\xa0]*Kor[I????])|[????]ki(?:nci[\s\xa0]*Kor[I????]|[\s\xa0]*Kor[I????]))ntlile|(?:(?:II|2)\.|II|2|Iki(?:nci)?|[????]ki(?:nci)?)[\s\xa0]*Korint(?:l[Ii????]le|oslula)|iki(?:nci[\s\xa0]*Kor[Ii????]nt(?:l[Ii????]le|oslula)|[\s\xa0]*Kor[Ii????]nt(?:l[Ii????]le|oslula)))r))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:\.?[\s\xa0]*Kor[I????]nt(?:l[I????]le|oslula)r|(?:\.?[\s\xa0]*)?Ko|Cor)|I[\s\xa0]*Kor[I????]nt(?:l[I????]le|oslula)r|(?:I(?:lk|\.)|[????]lk)[\s\xa0]*Kor[I????]nt(?:l[I????]le|oslula)r|Bir(?:inci[\s\xa0]*Kor[I????]nt(?:l[I????]le|oslula)|[\s\xa0]*Kor[I????]nt(?:l[I????]le|oslula))r)|(?:(?:[1I][\s\xa0]*Kor(?:int(?:l[Ii????]le|oslula)|[I????]ntlile)|ilk[\s\xa0]*Kor[Ii????]nt(?:l[Ii????]le|oslula)|(?:[1I]\.|Ilk|[????]lk)[\s\xa0]*Kor(?:int(?:l[Ii????]le|oslula)|[I????]ntlile)|Bir(?:inci[\s\xa0]*Kor(?:int(?:l[Ii????]le|oslula)|[I????]ntlile)|[\s\xa0]*Kor(?:int(?:l[Ii????]le|oslula)|[I????]ntlile)))r))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Gal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Gal(?:atyal[Ii????]lar)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:E(?:f(?:e(?:sl[Ii????]ler)?)?|ph)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phil"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:F(?:[I????]l[I????]p[I????]l[I????]ler|lp)|Phil)|(?:F(?:[I????]l(?:[I????]p(?:il[Ii????]|[I????]li)|ip[Ii????]l[Ii????])|il[Ii????]p[Ii????]l[Ii????])ler))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Col"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Kol(?:osel[Ii????]ler)?|Col))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:I(?:ki(?:nci[\s\xa0]*Selan[I????]kl[I????]|[\s\xa0]*Selan[I????]kl[I????])|I(?:\.[\s\xa0]*Selan[I????]kl[I????]|[\s\xa0]*Selan[I????]kl[I????]))ler|[????]ki(?:nci[\s\xa0]*Selan[I????]kl[I????]|[\s\xa0]*Selan[I????]kl[I????])ler|2(?:\.?[\s\xa0]*Selan[I????]kl[I????]ler|Thess|Se|\.?[\s\xa0]*Se))|(?:(?:iki(?:nci[\s\xa0]*Selan[Ii????]|[\s\xa0]*Selan[Ii????])kl[Ii????]|(?:II|2)[\s\xa0]*Selan(?:ikl[Ii????]|[I????]kli)|(?:II|2)\.[\s\xa0]*Selan(?:ikl[Ii????]|[I????]kli)|Iki(?:nci[\s\xa0]*Selan(?:ikl[Ii????]|[I????]kli)|[\s\xa0]*Selan(?:ikl[Ii????]|[I????]kli))|[????]ki(?:nci[\s\xa0]*Selan(?:ikl[Ii????]|[I????]kli)|[\s\xa0]*Selan(?:ikl[Ii????]|[I????]kli)))ler))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:\.?[\s\xa0]*Selan[I????]kl[I????]ler|Thess|Se|\.?[\s\xa0]*Se)|I[\s\xa0]*Selan[I????]kl[I????]ler|(?:I(?:lk|\.)|[????]lk)[\s\xa0]*Selan[I????]kl[I????]ler|Bir(?:inci[\s\xa0]*Selan[I????]kl[I????]|[\s\xa0]*Selan[I????]kl[I????])ler)|(?:(?:[1I][\s\xa0]*Selan(?:ikl[Ii????]|[I????]kli)|ilk[\s\xa0]*Selan[Ii????]kl[Ii????]|(?:[1I]\.|Ilk|[????]lk)[\s\xa0]*Selan(?:ikl[Ii????]|[I????]kli)|Bir(?:inci[\s\xa0]*Selan(?:ikl[Ii????]|[I????]kli)|[\s\xa0]*Selan(?:ikl[Ii????]|[I????]kli)))ler))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2Tim)|(?:2(?:(?:\.[\s\xa0]*T[I????]|[\s\xa0]*T[I????])moteos|\.[\s\xa0]*T[I????]|[\s\xa0]*T[I????]|Ti)|[????]ki(?:nci[\s\xa0]*T[I????]|[\s\xa0]*T[I????])moteos|I(?:ki(?:nci[\s\xa0]*T[I????]|[\s\xa0]*T[I????])|I(?:\.[\s\xa0]*T[I????]|[\s\xa0]*T[I????]))moteos)|(?:(?:I(?:ki(?:nci)?|I\.?)|[????]ki(?:nci)?)[\s\xa0]*Timoteos|2(?:\.?[\s\xa0]*Timoteos|\.?[\s\xa0]*Ti)|iki(?:nci[\s\xa0]*T[Ii????]|[\s\xa0]*T[Ii????])moteos))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1Tim)|(?:1(?:(?:\.[\s\xa0]*T[I????]|[\s\xa0]*T[I????])moteos|\.[\s\xa0]*T[I????]|[\s\xa0]*T[I????]|Ti)|I[\s\xa0]*T[I????]moteos|(?:I(?:lk|\.)|[????]lk)[\s\xa0]*T[I????]moteos|Bir(?:inci[\s\xa0]*T[I????]|[\s\xa0]*T[I????])moteos)|(?:1(?:\.?[\s\xa0]*Timoteos|\.?[\s\xa0]*Ti)|ilk[\s\xa0]*T[Ii????]moteos|I[\s\xa0]*Timoteos|(?:I(?:lk|\.)|[????]lk)[\s\xa0]*Timoteos|Bir(?:inci)?[\s\xa0]*Timoteos))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Titus"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:T[Ii????]t(?:us)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phlm"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:F(?:[Ii????]l[Ii????]mon|lm)|Phlm))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Heb"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:[I????]br(?:an[I????]ler)?|Heb)|(?:ibr(?:an[Ii????]ler)?|[I????]braniler))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jas"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Yak(?:up)?|Jas))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Petrus|Pet|\.[\s\xa0]*Petrus))|(?:[i????]ki(?:nci)?[\s\xa0]*Petrus|2(?:\.[\s\xa0]*|[\s\xa0]*)?Pe|I(?:ki(?:nci)?|I\.?)[\s\xa0]*Petrus))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Petrus|Pet|\.[\s\xa0]*Petrus))|(?:(?:I(?:lk|\.)|[i????]lk)[\s\xa0]*Petrus|1(?:\.[\s\xa0]*|[\s\xa0]*)?Pe|I[\s\xa0]*Petrus|Bir(?:inci)?[\s\xa0]*Petrus))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Jude"],
        ...
        osis: ["Tob"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Tob(?:[Ii????]t)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jdt"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:(?:Yud[Ii????]|Jd)t))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Bar"],
        apocrypha: true,
        ...
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Makabeler|Macc|\.[\s\xa0]*Makabeler)|[i????]ki(?:nci)?[\s\xa0]*Makabeler|I(?:ki(?:nci)?|I\.?)[\s\xa0]*Makabeler))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:III|3)[\s\xa0]*Makabeler|3Macc|(?:III|3)\.[\s\xa0]*Makabeler|[U\xDC][c\xE7](?:[u\xFC]nc[u\xFC])?[\s\xa0]*Makabeler))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:IV|4)[\s\xa0]*Makabeler|4Macc|(?:IV|4)\.[\s\xa0]*Makabeler|D[o\xF6]r(?:d[u\xFC]nc[u\xFC]|t)[\s\xa0]*Makabeler))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:[i????]lk|1\.|I(?:lk|\.))[\s\xa0]*Makabeler|[1I][\s\xa0]*Makabeler|1Macc|Bir(?:inci)?[\s\xa0]*Makabeler))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }
    ];
