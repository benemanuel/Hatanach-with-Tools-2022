(function() {
  ...
  bcv_parser.prototype.regexps.escaped_passage = RegExp("(?:^|[^\\x1f\\x1e\\dA-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:ch(?:apters?|a?pts?\\.?|a?p?s?\\.?)?\\s*\\d+\\s*(?:[\\u2013\\u2014\\-]|through|thru|to)\\s*\\d+\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*)|(?:ch(?:apters?|a?pts?\\.?|a?p?s?\\.?)?\\s*\\d+\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*)|(?:\\d+(?:th|nd|st)\\s*ch(?:apter|a?pt\\.?|a?p?\\.?)?\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*))?\\x1f(\\d+)(?:/\\d+)?\\x1f(?:/\\d+\\x1f|[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014]|opschrift(?![a-z])|en" + bcv_parser.prototype.regexps.space + "+volgende" + bcv_parser.prototype.regexps.space + "+verzen|zie" + bcv_parser.prototype.regexps.space + "+ook|hoofdstukken|hoofdstuk|verzen|vers|vgl|en|vs|-|v|[a-e](?!\\w)|$)+)", "gi");
    ...
    books = [
      {
        ...
        osis: ["Gen"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:Genesis)|(?:(?:1e?|I)[\s\xa0]*Mozes|Beresjiet|Ge?n|(?:1e?|I)\.[\s\xa0]*Mozes|Eerste[\s\xa0]*Mozes))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Exod"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:Exodus)|(?:(?:2e?|II)[\s\xa0]*Mozes|Sjemot|Exod|Ex|(?:2e?|II)\.[\s\xa0]*Mozes|Tweede[\s\xa0]*Mozes))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Bel"],
        apocrypha: true,
        ...
        osis: ["Lev"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:Leviticus)|(?:(?:3e?|III)[\s\xa0]*Mozes|[VW]ajikra|Le?v|(?:3e?|III)\.[\s\xa0]*Mozes|Derde[\s\xa0]*Mozes))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Num"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:B[ae]midbar|Numb?eri|Num?|(?:IV|4)[\s\xa0]*Mozes|(?:IV|4)\.[\s\xa0]*Mozes|Vierde[\s\xa0]*Mozes))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Sir"],
        apocrypha: true,
        ...
        osis: ["Deut"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:D(?:e(?:ut(?:eronomium)?|wariem)|t)|(?:V(?:ijfde|\.)?|5\.?)[\s\xa0]*Mozes))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Josh"],
        ...
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:[13]e|[13]|I(?:II)?)[\s\xa0]*E(?:sdras|zra)|1Esd|(?:[13]e|[13]|I(?:II)?)\.[\s\xa0]*E(?:sdras|zra)|Derde[\s\xa0]*E(?:sdras|zra)|Eerste[\s\xa0]*E(?:sdras|zra)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:I[IV]|4|2e?)[\s\xa0]*E(?:sdras|zra)|2Esd|(?:I[IV]|4|2e?)\.[\s\xa0]*E(?:sdras|zra)|Vierde[\s\xa0]*E(?:sdras|zra)|Tweede[\s\xa0]*E(?:sdras|zra)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Isa"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:J(?:es(?:aja)?|s)|Isa))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2[\s\xa0]*Sam(?:u[e\xEB]l)?|Samuel[\s\xa0]*II|2Sam|2[\s\xa0]*S|(?:2e|II)[\s\xa0]*Sam(?:u[e\xEB]l)?|(?:2e?|II)\.[\s\xa0]*Sam(?:u[e\xEB]l)?|Tweede[\s\xa0]*Sam(?:u[e\xEB]l)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1[\s\xa0]*Sam(?:u[e\xEB]l)?|Samuel[\s\xa0]*I|1Sam|1[\s\xa0]*S|(?:1e|I)[\s\xa0]*Sam(?:u[e\xEB]l)?|(?:1e?|I)\.[\s\xa0]*Sam(?:u[e\xEB]l)?|Eerste[\s\xa0]*Sam(?:u[e\xEB]l)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:2e?|II)[\s\xa0]*Ko(?:n(?:ingen)?)?|2Kgs|(?:2e?|II)\.[\s\xa0]*Ko(?:n(?:ingen)?)?|Tweede[\s\xa0]*Ko(?:n(?:ingen)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:1e?|I)[\s\xa0]*Ko(?:n(?:ingen)?)?|1Kgs|(?:1e?|I)\.[\s\xa0]*Ko(?:n(?:ingen)?)?|Eerste[\s\xa0]*Ko(?:n(?:ingen)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Kron(?:ieken)?|(?:[\s\xa0]*K|Ch)r)|(?:2e|II)[\s\xa0]*Kron(?:ieken)?|(?:2e?|II)\.[\s\xa0]*Kron(?:ieken)?|Tweede[\s\xa0]*Kron(?:ieken)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Kron(?:ieken)?|(?:[\s\xa0]*K|Ch)r)|(?:1e|I)[\s\xa0]*Kron(?:ieken)?|(?:1e?|I)\.[\s\xa0]*Kron(?:ieken)?|Eerste[\s\xa0]*Kron(?:ieken)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        ...
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1John)|(?:(?:1e?|I)\.[\s\xa0]*Joh(?:annes)?|(?:1e?|I)[\s\xa0]*Joh(?:annes)?|Eerste[\s\xa0]*Joh(?:annes)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2John)|(?:(?:2e?|II)\.[\s\xa0]*Joh(?:annes)?|(?:2e?|II)[\s\xa0]*Joh(?:annes)?|Tweede[\s\xa0]*Joh(?:annes)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:3John)|(?:(?:3e?|III)\.[\s\xa0]*Joh(?:annes)?|(?:3e?|III)[\s\xa0]*Joh(?:annes)?|Derde[\s\xa0]*Joh(?:annes)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        ...
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:2e?|II)[\s\xa0]*(?:Kor(?:int(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))?|Corint(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))|2Cor|(?:2e?|II)\.[\s\xa0]*(?:Kor(?:int(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))?|Corint(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))|Tweede[\s\xa0]*(?:Kor(?:int(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))?|Corint(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:1e?|I)[\s\xa0]*(?:Kor(?:int(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))?|Corint(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))|1Cor|(?:1e?|I)\.[\s\xa0]*(?:Kor(?:int(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))?|Corint(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))|Eerste[\s\xa0]*(?:Kor(?:int(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))?|Corint(?:h(?:i[e\xEB]rs?|e)|i[e\xEB]rs?))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Gal"],
        ...
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:2e|II)[\s\xa0]*T(?:es(?:s(?:alonicenzen)?)?|hess(?:alonicenzen)?)|2(?:[\s\xa0]*Th?ess(?:alonicenzen)?|(?:[\s\xa0]*Th?e|Thes)s)|(?:2e?|II)\.[\s\xa0]*T(?:es(?:s(?:alonicenzen)?)?|hess(?:alonicenzen)?)|Tweede[\s\xa0]*T(?:es(?:s(?:alonicenzen)?)?|hess(?:alonicenzen)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:1e|I)[\s\xa0]*T(?:es(?:s(?:alonicenzen)?)?|hess(?:alonicenzen)?)|1(?:[\s\xa0]*Th?ess(?:alonicenzen)?|(?:[\s\xa0]*Th?e|Thes)s)|(?:1e?|I)\.[\s\xa0]*T(?:es(?:s(?:alonicenzen)?)?|hess(?:alonicenzen)?)|Eerste[\s\xa0]*T(?:es(?:s(?:alonicenzen)?)?|hess(?:alonicenzen)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:2e?|II)[\s\xa0]*Tim(?:ot(?:he[u\xFC]|e[u\xFC])s)?|2Tim|(?:2e?|II)\.[\s\xa0]*Tim(?:ot(?:he[u\xFC]|e[u\xFC])s)?|Tweede[\s\xa0]*Tim(?:ot(?:he[u\xFC]|e[u\xFC])s)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:1e?|I)[\s\xa0]*Tim(?:ot(?:he[u\xFC]|e[u\xFC])s)?|1Tim|(?:1e?|I)\.[\s\xa0]*Tim(?:ot(?:he[u\xFC]|e[u\xFC])s)?|Eerste[\s\xa0]*Tim(?:ot(?:he[u\xFC]|e[u\xFC])s)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Titus"],
        ...
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Pet(?:r(?:us)?)?|[\s\xa0]*Pe|Pet)|(?:2e|II)[\s\xa0]*Pet(?:r(?:us)?)?|(?:2e?|II)\.[\s\xa0]*Pet(?:r(?:us)?)?|Tweede[\s\xa0]*Pet(?:r(?:us)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Pet(?:r(?:us)?)?|[\s\xa0]*Pe|Pet)|(?:1e|I)[\s\xa0]*Pet(?:r(?:us)?)?|(?:1e?|I)\.[\s\xa0]*Pet(?:r(?:us)?)?|Eerste[\s\xa0]*Pet(?:r(?:us)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Jude"],
        ...
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:2e?|II)[\s\xa0]*Mak(?:kabee[e\xEB]n)?|2Macc|(?:2e?|II)\.[\s\xa0]*Mak(?:kabee[e\xEB]n)?|Tweede[\s\xa0]*Mak(?:kabee[e\xEB]n)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:3e?|III)[\s\xa0]*Mak(?:kabee[e\xEB]n)?|3Macc|(?:3e?|III)\.[\s\xa0]*Mak(?:kabee[e\xEB]n)?|Derde[\s\xa0]*Mak(?:kabee[e\xEB]n)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:IV|4)[\s\xa0]*Mak(?:kabee[e\xEB]n)?|4Macc|(?:IV|4)\.[\s\xa0]*Mak(?:kabee[e\xEB]n)?|Vierde[\s\xa0]*Mak(?:kabee[e\xEB]n)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:1e?|I)[\s\xa0]*Mak(?:kabee[e\xEB]n)?|1Macc|(?:1e?|I)\.[\s\xa0]*Mak(?:kabee[e\xEB]n)?|Eerste[\s\xa0]*Mak(?:kabee[e\xEB]n)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezek", "Ezra"],
