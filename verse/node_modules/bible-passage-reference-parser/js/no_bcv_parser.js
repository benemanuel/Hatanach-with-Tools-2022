(function() {
  ...
  bcv_parser.prototype.regexps.escaped_passage = /(?:^|[^\x1f\x1e\dA-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014]|overskrift(?![a-z])|kapittelet|kapitlene|kapittel|kapitler|kapitel|vers|kap|ff|og|cf|jf|f|-|v|[a-e](?!\w)|$)+)/gi;
    ...
    books = [
      {
        ...
        osis: ["Gen"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1[\s\xa0]*Mos(?:ebok)?|Gen(?:esis)?|1\.[\s\xa0]*Mos(?:ebok)?|F\xF8rste[\s\xa0]*Mos(?:ebok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Exod"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2[\s\xa0]*Mos(?:ebok)?|Exod|2\.[\s\xa0]*Mos(?:ebok)?|An(?:dre[\s\xa0]*Mos(?:ebok)?|nen[\s\xa0]*Mosebok)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Bel"],
        apocrypha: true,
        ...
        osis: ["Lev"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:3[\s\xa0]*Mos(?:ebok)?|Lev(?:iticus)?|3\.[\s\xa0]*Mos(?:ebok)?|Tredje[\s\xa0]*Mos(?:ebok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Num"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:4[\s\xa0]*Mos(?:ebok)?|Num|4\.[\s\xa0]*Mos(?:ebok)?|Fjerde[\s\xa0]*Mos(?:ebok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Sir"],
        apocrypha: true,
        ...
        osis: ["Deut"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:5[\s\xa0]*Mos(?:ebok)?|Deut|5\.[\s\xa0]*Mos(?:ebok)?|Femte[\s\xa0]*Mos(?:ebok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Josh"],
        ...
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:Tredje|3\.?)[\s\xa0]*Esra|1Esd|1[\s\xa0]*Es(?:dras|ra)|1\.[\s\xa0]*Es(?:dras|ra)|F\xF8rste[\s\xa0]*Es(?:dras|ra)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:Fjerde|4\.?)[\s\xa0]*Esra|2Esd|2[\s\xa0]*Es(?:dras|ra)|2\.[\s\xa0]*Es(?:dras|ra)|Andre[\s\xa0]*Es(?:dras|ra)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Isa"],
        ...
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Sam(?:uel(?:sbok)?)?|Sam|\.[\s\xa0]*Sam(?:uel(?:sbok)?)?)|Andre[\s\xa0]*Sam(?:uel(?:sbok)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Sam(?:uel(?:s(?:bok)?)?)?|Sam|\.[\s\xa0]*Sam(?:uel(?:s(?:bok)?)?)?)|F\xF8rste[\s\xa0]*Sam(?:uel(?:s(?:bok)?)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Kong(?:ebok)?|Kgs|\.[\s\xa0]*Kong(?:ebok)?)|Andre[\s\xa0]*Kong(?:ebok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Kong(?:ebok)?|Kgs|\.[\s\xa0]*Kong(?:ebok)?)|F\xF8rste[\s\xa0]*Kong(?:ebok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Kr\xF8(?:n(?:ikebok)?)?|Chr|\.[\s\xa0]*Kr\xF8(?:n(?:ikebok)?)?)|Andre[\s\xa0]*Kr\xF8(?:n(?:ikebok)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Kr\xF8(?:n(?:ikebok)?)?|Chr|\.[\s\xa0]*Kr\xF8(?:n(?:ikebok)?)?)|F\xF8rste[\s\xa0]*Kr\xF8(?:n(?:ikebok)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        ...
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Johannes|John|\.[\s\xa0]*Johannes)|F\xF8rste[\s\xa0]*Johannes|(?:F\xF8rste|1\.?)[\s\xa0]*Joh|Johannes???[\s\xa0]*f\xF8rste[\s\xa0]*brev))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Johannes|John|\.[\s\xa0]*Johannes)|Andre[\s\xa0]*Johannes|(?:Andre|2\.?)[\s\xa0]*Joh|Johannes???[\s\xa0]*andre[\s\xa0]*brev))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:3(?:[\s\xa0]*Johannes|John|\.[\s\xa0]*Johannes)|Tredje[\s\xa0]*Johannes|(?:Tredje|3\.?)[\s\xa0]*Joh|Johannes???[\s\xa0]*tredje[\s\xa0]*brev))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        ...
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:Andre|2\.?)[\s\xa0]*Korintierne)|(?:2(?:[\s\xa0]*(?:korinterbrev|Korinter)|Cor|\.[\s\xa0]*(?:korinterbrev|Korinter))|Andre[\s\xa0]*(?:korinterbrev|Korinter)|(?:Andre|2\.?)[\s\xa0]*Kor|Paulus???[\s\xa0]*andre[\s\xa0]*brev[\s\xa0]*til[\s\xa0]*korinterne))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:F\xF8rste|1\.?)[\s\xa0]*Korintierne)|(?:1(?:[\s\xa0]*(?:korinterbrev|Korinter)|Cor|\.[\s\xa0]*(?:korinterbrev|Korinter))|F\xF8rste[\s\xa0]*(?:korinterbrev|Korinter)|(?:F\xF8rste|1\.?)[\s\xa0]*Kor|Paulus???[\s\xa0]*f\xF8rste[\s\xa0]*brev[\s\xa0]*til[\s\xa0]*korinterne))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Gal"],
        ...
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:Andre|2\.?)[\s\xa0]*Tessalonikerne)|(?:2(?:[\s\xa0]*(?:tessalonikerbrev|Tessaloniker)|Thess|\.[\s\xa0]*(?:tessalonikerbrev|Tessaloniker))|Andre[\s\xa0]*(?:tessalonikerbrev|Tessaloniker)|(?:Andre|2\.?)[\s\xa0]*Tess|Paulus???[\s\xa0]*andre[\s\xa0]*brev[\s\xa0]*til[\s\xa0]*tessalonikerne))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:F\xF8rste|1\.?)[\s\xa0]*Tessalonikerne)|(?:1(?:[\s\xa0]*(?:tessalonikerbrev|Tessaloniker)|Thess|\.[\s\xa0]*(?:tessalonikerbrev|Tessaloniker))|F\xF8rste[\s\xa0]*(?:tessalonikerbrev|Tessaloniker)|(?:F\xF8rste|1\.?)[\s\xa0]*Tess|Paulus???[\s\xa0]*f\xF8rste[\s\xa0]*brev[\s\xa0]*til[\s\xa0]*tessalonikerne))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Timoteusbrev|Tim|\.[\s\xa0]*Timoteusbrev)|Andre[\s\xa0]*Timoteusbrev|2(?:\.[\s\xa0]*Tim(?:oteus)?|[\s\xa0]*Tim(?:oteus)?)|Andre[\s\xa0]*Tim(?:oteus)?|Paulus???[\s\xa0]*andre[\s\xa0]*brev[\s\xa0]*til[\s\xa0]*Timoteus))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Timoteusbrev|Tim|\.[\s\xa0]*Timoteusbrev)|F\xF8rste[\s\xa0]*Timoteusbrev|1(?:\.[\s\xa0]*Tim(?:oteus)?|[\s\xa0]*Tim(?:oteus)?)|F\xF8rste[\s\xa0]*Tim(?:oteus)?|Paulus???[\s\xa0]*f\xF8rste[\s\xa0]*brev[\s\xa0]*til[\s\xa0]*Timoteus))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Titus"],
        ...
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:Andre|2\.?)[\s\xa0]*Petersbrev)|(?:(?:Andre|2\.?)[\s\xa0]*Peters)|(?:2(?:[\s\xa0]*Peter|Pet|\.[\s\xa0]*Peter)|Andre[\s\xa0]*Peter|(?:Andre|2\.?)[\s\xa0]*Pet|Peters[\s\xa0]*andre[\s\xa0]*brev))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:F\xF8rste|1\.?)[\s\xa0]*Petersbrev)|(?:(?:F\xF8rste|1\.?)[\s\xa0]*Peters)|(?:1(?:[\s\xa0]*Peter|Pet|\.[\s\xa0]*Peter)|F\xF8rste[\s\xa0]*Peter|(?:F\xF8rste|1\.?)[\s\xa0]*Pet|Peters[\s\xa0]*f\xF8rste[\s\xa0]*brev))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Jude"],
        ...
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Makk(?:abeerbok)?|Macc|\.[\s\xa0]*Makk(?:abeerbok)?)|Andre[\s\xa0]*Makk(?:abeerbok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:3(?:[\s\xa0]*Makk(?:abeerbok)?|Macc|\.[\s\xa0]*Makk(?:abeerbok)?)|Tredje[\s\xa0]*Makk(?:abeerbok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:4(?:[\s\xa0]*Makk(?:abeerbok)?|Macc|\.[\s\xa0]*Makk(?:abeerbok)?)|Fjerde[\s\xa0]*Makk(?:abeerbok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Makk(?:abeerbok)?|Macc|\.[\s\xa0]*Makk(?:abeerbok)?)|F\xF8rste[\s\xa0]*Makk(?:abeerbok)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }
    ];
