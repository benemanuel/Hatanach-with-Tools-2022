(function() {
  ...
  bcv_parser.prototype.regexps.escaped_passage = /(?:^|[^\x1f\x1e\dA-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014]|(?:titik|pamagat)(?![a-z])|kapitulo|talatang|pangkat|pang|kap|tal|at|k|-|[a-e](?!\w)|$)+)/gi;
    ...
    books = [
      {
        ...
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1[\s\xa0]*Esdras)|(?:1(?:[\s\xa0]*?Esd|[\s\xa0]*Ezra)|I[\s\xa0]*E(?:sdras|zra)|[1I]\.[\s\xa0]*E(?:sdras|zra)|Una(?:ng[\s\xa0]*E(?:sdras|zra)|[\s\xa0]*E(?:sdras|zra))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2[\s\xa0]*Esdras)|(?:I(?:I(?:\.[\s\xa0]*E(?:sdras|zra)|[\s\xa0]*E(?:sdras|zra))|kalawang[\s\xa0]*E(?:sdras|zra))|2(?:\.[\s\xa0]*E(?:sdras|zra)|[\s\xa0]*?Esd|[\s\xa0]*Ezra)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Isa"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Is(?:a(?:[i\\xED]a[hs]?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Samuel|[\s\xa0]*?Sam|\.[\s\xa0]*Samuel)|I(?:kalawang|I\.?)[\s\xa0]*Samuel))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Samuel|[\s\xa0]*?Sam)|I[\s\xa0]*Samuel|[1I]\.[\s\xa0]*Samuel|Una(?:ng)?[\s\xa0]*Samuel))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2[\s\xa0]*Hari)|(?:I(?:I[\s\xa0]*(?:Mga[\s\xa0]*)?|V\.?[\s\xa0]*Mga[\s\xa0]*|I\.[\s\xa0]*(?:Mga[\s\xa0]*)?|ka(?:lawang[\s\xa0]*(?:Mga[\s\xa0]*)?|apat[\s\xa0]*Mga[\s\xa0]*))Hari|(?:[24]|4\.)[\s\xa0]*Mga[\s\xa0]*Hari|2(?:[\s\xa0]*Ha|Kgs)|2\.[\s\xa0]*(?:Mga[\s\xa0]*)?Hari))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1[\s\xa0]*Hari)|(?:(?:Unang|1\.|Una)[\s\xa0]*Hari|1(?:[\s\xa0]*Ha|Kgs)|(?:Unang|1\.|Una|1)[\s\xa0]*Mga[\s\xa0]*Hari|3[\s\xa0]*Mga[\s\xa0]*Hari|3\.[\s\xa0]*Mga[\s\xa0]*Hari|I(?:\.?[\s\xa0]*Mga|\.|II[\s\xa0]*Mga|II\.[\s\xa0]*Mga|katlong[\s\xa0]*Mga)?[\s\xa0]*Hari))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:I(?:I(?:\.[\s\xa0]*(?:Kronik(?:el|a)|Chronicle|Cronica|Mga[\s\xa0]*(?:Cronic|Kronik)a|Paralipomeno)|[\s\xa0]*(?:Kronik(?:el|a)|Chronicle|Cronica|Mga[\s\xa0]*(?:Cronic|Kronik)a|Paralipomeno))|kalawang[\s\xa0]*(?:Kronik(?:el|a)|Chronicle|Cronica|Mga[\s\xa0]*(?:Cronic|Kronik)a|Paralipomeno))|2(?:[\s\xa0]*Kronik(?:el|a)|Chr|[\s\xa0]*Chronicle|[\s\xa0]*Cronica|[\s\xa0]*Mga[\s\xa0]*(?:Cronic|Kronik)a|[\s\xa0]*Cron?|[\s\xa0]*Paralipomeno|\.[\s\xa0]*(?:Kronik(?:el|a)|Chronicle|Cronica|Mga[\s\xa0]*(?:Cronic|Kronik)a|Paralipomeno))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Kronik(?:el|a)|Chr|[\s\xa0]*Chronicle|[\s\xa0]*Cronica|[\s\xa0]*Mga[\s\xa0]*(?:Cronic|Kronik)a|[\s\xa0]*Cron?|[\s\xa0]*Paralipomeno)|I[\s\xa0]*(?:Kronik(?:el|a)|Chronicle|Cronica|Mga[\s\xa0]*(?:Cronic|Kronik)a|Paralipomeno)|[1I]\.[\s\xa0]*(?:Kronik(?:el|a)|Chronicle|Cronica|Mga[\s\xa0]*(?:Cronic|Kronik)a|Paralipomeno)|Una(?:ng[\s\xa0]*(?:Kronik(?:el|a)|Chronicle|Cronica|Mga[\s\xa0]*(?:Cronic|Kronik)a|Paralipomeno)|[\s\xa0]*(?:Kronik(?:el|a)|Chronicle|Cronica|Mga[\s\xa0]*(?:Cronic|Kronik)a|Paralipomeno))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        ...
        osis: ["SgThree"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:Aw(?:it[\s\xa0]*ng[\s\xa0]*(?:Tatlong[\s\xa0]*(?:B(?:anal[\s\xa0]*na[\s\xa0]*Kabataan|inata)|Kabataan(?:g[\s\xa0]*Banal)?)|3[\s\xa0]*Kabataan)|[\s\xa0]*ng[\s\xa0]*3[\s\xa0]*Kab)|Tatlong[\s\xa0]*Kabataan|SgThree))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Song"],
        ...
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:1(?:Joh|[\s\xa0]*J|[\s\xa0]*Jua)|I[\s\xa0]*Jua|[1I]\.[\s\xa0]*Jua|Una(?:ng)?[\s\xa0]*Jua)n))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:2(?:Joh|[\s\xa0]*J|[\s\xa0]*Jua|\.[\s\xa0]*Jua)|I(?:kalawang|I\.?)[\s\xa0]*Jua)n))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:3(?:Joh|[\s\xa0]*J|[\s\xa0]*Jua|\.[\s\xa0]*Jua)|I(?:katlong|II\.?)[\s\xa0]*Jua)n))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        ...
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2[\s\xa0]*Pedro)|(?:I(?:kalawang|I\.?)[\s\xa0]*Pedro|2(?:[\s\xa0]*Ped|Pet|\.[\s\xa0]*Pedro)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1[\s\xa0]*Pedro)|(?:1(?:[\s\xa0]*Ped|Pet)|I[\s\xa0]*Pedro|[1I]\.[\s\xa0]*Pedro|Una(?:ng)?[\s\xa0]*Pedro))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Jude"],
        ...
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:I(?:I(?:\.[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?))|kalawang[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?))|2(?:[\s\xa0]*Macabeos|[\s\xa0]*Mcb|Macc|[\s\xa0]*Macabeo|[\s\xa0]*Mga[\s\xa0]*Macabeo|\.[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:I(?:II(?:\.[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?))|katlong[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?))|3(?:[\s\xa0]*Macabeos|[\s\xa0]*Mcb|Macc|[\s\xa0]*Macabeo|[\s\xa0]*Mga[\s\xa0]*Macabeo|\.[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:I(?:V(?:\.[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?))|kaapat[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?))|4(?:[\s\xa0]*Macabeos|[\s\xa0]*Mcb|Macc|[\s\xa0]*Macabeo|[\s\xa0]*Mga[\s\xa0]*Macabeo|\.[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Macabeos|[\s\xa0]*Mcb|Macc|[\s\xa0]*Macabeo|[\s\xa0]*Mga[\s\xa0]*Macabeo)|I[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|[1I]\.[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|Una(?:ng[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?)|[\s\xa0]*M(?:ga[\s\xa0]*Macabeo|acabeos?))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezek", "Ezra"],
