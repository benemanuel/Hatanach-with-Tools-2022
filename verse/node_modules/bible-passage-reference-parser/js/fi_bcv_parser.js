(function() {
  ...
  bcv_parser.prototype.regexps.escaped_passage = /(?:^|[^\x1f\x1e\dA-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:[\u2013\u2014\-]|through|thru|to)\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:ch(?:apters?|a?pts?\.?|a?p?s?\.?)?\s*\d+\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*)|(?:\d+(?:th|nd|st)\s*ch(?:apter|a?pt\.?|a?p?\.?)?\s*(?:from|of|in)(?:\s+the\s+book\s+of)?\s*))?\x1f(\d+)(?:\/\d+)?\x1f(?:\/\d+\x1f|[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014]|johdannolla(?![a-z])|ja(?![a-z])|jakeissa|jakeet|luvut|luvun|luku|vrt|ss|???|[a-e](?!\w)|$)+)/gi;
  ...
  bcv_parser.prototype.regexps.first = "(?:Ensimm[??a]inen|1|I)\\.?" + bcv_parser.prototype.regexps.space + "*";
    ...
    books = [
      {
        ...
        osis: ["Gen"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|1[\s\xa0]*Moos|Gen|I[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|[1I]\.[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|Ensimm[a\xE4]inen[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Exod"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|2[\s\xa0]*Moos|Exod|II[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|(?:II|2)\.[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|Toinen[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Bel"],
        apocrypha: true,
        ...
        osis: ["Lev"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:3[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|3[\s\xa0]*Moos|Lev|III[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|(?:III|3)\.[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|Kolmas[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Num"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:4[\s\xa0]*Moos(?:eksen(?:[\s\xa0]*kirja)?)?|IV[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|(?:IV|4)\.[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|N(?:elj[a\xE4]s[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|um)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Sir"],
        apocrypha: true,
        ...
        osis: ["Deut"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:V(?:\.[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|iides[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?)|5[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?|5[\s\xa0]*Moos|Deut|5\.[\s\xa0]*Mooseksen(?:[\s\xa0]*kirja)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Josh"],
        ...
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Esra|Esd))|(?:I[\s\xa0]*Esra|1[\s\xa0]*Es|[1I]\.[\s\xa0]*Esra|Ensimm[a\xE4]inen[\s\xa0]*Esra))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Esra|Esd))|(?:(?:II|2)\.[\s\xa0]*Esra|II[\s\xa0]*Esra|2[\s\xa0]*Es|Toinen[\s\xa0]*Esra))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Isa"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jes(?:ajan(?:[\\s\\xa0]*kirja)?)?|Isa))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Samuelin(?:[\s\xa0]*kirja)?|[\s\xa0]*?Sam)|II[\s\xa0]*Samuelin(?:[\s\xa0]*kirja)?|(?:II|2)\.[\s\xa0]*Samuelin(?:[\s\xa0]*kirja)?|Toinen[\s\xa0]*Samuelin(?:[\s\xa0]*kirja)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Samuelin(?:[\s\xa0]*kirja)?|[\s\xa0]*?Sam)|I[\s\xa0]*Samuelin(?:[\s\xa0]*kirja)?|[1I]\.[\s\xa0]*Samuelin(?:[\s\xa0]*kirja)?|Ensimm[a\xE4]inen[\s\xa0]*Samuelin(?:[\s\xa0]*kirja)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Kuninkaiden(?:[\s\xa0]*kirja)?|[\s\xa0]*Kun|Kgs)|II[\s\xa0]*Kuninkaiden(?:[\s\xa0]*kirja)?|(?:II|2)\.[\s\xa0]*Kuninkaiden(?:[\s\xa0]*kirja)?|Toinen[\s\xa0]*Kuninkaiden(?:[\s\xa0]*kirja)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Kuninkaiden(?:[\s\xa0]*kirja)?|[\s\xa0]*Kun|Kgs)|I[\s\xa0]*Kuninkaiden(?:[\s\xa0]*kirja)?|[1I]\.[\s\xa0]*Kuninkaiden(?:[\s\xa0]*kirja)?|Ensimm[a\xE4]inen[\s\xa0]*Kuninkaiden(?:[\s\xa0]*kirja)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2[\s\xa0]*Aikakirja)|(?:2(?:[\s\xa0]*Aikak|Chr|[\s\xa0]*Aik)|II[\s\xa0]*Aikakirja|(?:II|2)\.[\s\xa0]*Aikakirja|Toinen[\s\xa0]*Aikakirja))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1[\s\xa0]*Aikakirja)|(?:1(?:[\s\xa0]*Aikak|Chr|[\s\xa0]*Aik)|I[\s\xa0]*Aikakirja|[1I]\.[\s\xa0]*Aikakirja|Ensimm[a\xE4]inen[\s\xa0]*Aikakirja))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        ...
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1John)|(?:1[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?|I[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?|[1I]\.[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?|Ensimm[a\xE4]inen[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2John)|(?:(?:II|2)\.[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?|(?:II|2)[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?|Toinen[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:3John)|(?:3[\s\xa0]*Joh(?:anneksen(?:[\s\xa0]*kirje)?)?|III[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?|(?:III|3)\.[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?|Kolmas[\s\xa0]*Johanneksen(?:[\s\xa0]*kirje)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        ...
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2[\s\xa0]*Tessalonikalaisille)|(?:2(?:[\s\xa0]*Tessalonikalaiskirje|(?:[\s\xa0]*T|Th)ess|[\s\xa0]*Kirje[\s\xa0]*tessalonikalaisille)|II[\s\xa0]*(?:Tessalonikalais(?:kirj|ill)|Kirje[\s\xa0]*tessalonikalaisill)e|(?:II|2)\.[\s\xa0]*(?:Tessalonikalais(?:kirj|ill)|Kirje[\s\xa0]*tessalonikalaisill)e|Toinen[\s\xa0]*(?:Tessalonikalais(?:kirj|ill)|Kirje[\s\xa0]*tessalonikalaisill)e))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1[\s\xa0]*Tessalonikalaisille)|(?:1(?:[\s\xa0]*Tessalonikalaiskirje|(?:[\s\xa0]*T|Th)ess|[\s\xa0]*Kirje[\s\xa0]*tessalonikalaisille)|I[\s\xa0]*(?:Tessalonikalais(?:kirj|ill)|Kirje[\s\xa0]*tessalonikalaisill)e|[1I]\.[\s\xa0]*(?:Tessalonikalais(?:kirj|ill)|Kirje[\s\xa0]*tessalonikalaisill)e|Ensimm[a\xE4]inen[\s\xa0]*(?:Tessalonikalais(?:kirj|ill)|Kirje[\s\xa0]*tessalonikalaisill)e))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2[\s\xa0]*Timoteukselle)|(?:II[\s\xa0]*(?:Timoteu(?:ksell|skirj)|Kirje[\s\xa0]*Timoteuksell)e|2(?:[\s\xa0]*Kirje[\s\xa0]*Timoteukselle|[\s\xa0]*Timoteuskirje|[\s\xa0]*?Tim)|(?:II|2)\.[\s\xa0]*(?:Timoteu(?:ksell|skirj)|Kirje[\s\xa0]*Timoteuksell)e|Toinen[\s\xa0]*(?:Timoteu(?:ksell|skirj)|Kirje[\s\xa0]*Timoteuksell)e))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1[\s\xa0]*Timoteukselle)|(?:I[\s\xa0]*(?:Timoteu(?:ksell|skirj)|Kirje[\s\xa0]*Timoteuksell)e|1(?:[\s\xa0]*Kirje[\s\xa0]*Timoteukselle|[\s\xa0]*Timoteuskirje|[\s\xa0]*?Tim)|[1I]\.[\s\xa0]*(?:Timoteu(?:ksell|skirj)|Kirje[\s\xa0]*Timoteuksell)e|Ensimm[a\xE4]inen[\s\xa0]*(?:Timoteu(?:ksell|skirj)|Kirje[\s\xa0]*Timoteuksell)e))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Titus"],
        ...
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*Pietarin(?:[\s\xa0]*kirje)?|(?:[\s\xa0]*Pi|P)et)|II[\s\xa0]*Pietarin(?:[\s\xa0]*kirje)?|(?:II|2)\.[\s\xa0]*Pietarin(?:[\s\xa0]*kirje)?|Toinen[\s\xa0]*Pietarin(?:[\s\xa0]*kirje)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*Pietarin(?:[\s\xa0]*kirje)?|(?:[\s\xa0]*Pi|P)et)|I[\s\xa0]*Pietarin(?:[\s\xa0]*kirje)?|[1I]\.[\s\xa0]*Pietarin(?:[\s\xa0]*kirje)?|Ensimm[a\xE4]inen[\s\xa0]*Pietarin(?:[\s\xa0]*kirje)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Jude"],
        ...
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:2(?:[\s\xa0]*makkabilaiskirja|[\s\xa0]*makk|Macc)|II[\s\xa0]*makkabilaiskirja|(?:II|2)\.[\s\xa0]*makkabilaiskirja|Toinen[\s\xa0]*makkabilaiskirja))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:3(?:[\s\xa0]*makkabilaiskirja|[\s\xa0]*makk|Macc)|III[\s\xa0]*makkabilaiskirja|(?:III|3)\.[\s\xa0]*makkabilaiskirja|Kolmas[\s\xa0]*makkabilaiskirja))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:4(?:[\s\xa0]*makkabilaiskirja|[\s\xa0]*makk|Macc)|IV[\s\xa0]*makkabilaiskirja|(?:IV|4)\.[\s\xa0]*makkabilaiskirja|Nelj[a\xE4]s[\s\xa0]*makkabilaiskirja))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-z????????-????-????-?????-??????-??????-??????-??????-??????-??????-???])((?:1(?:[\s\xa0]*makkabilaiskirja|[\s\xa0]*makk|Macc)|I[\s\xa0]*makkabilaiskirja|[1I]\.[\s\xa0]*makkabilaiskirja|Ensimm[a\xE4]inen[\s\xa0]*makkabilaiskirja))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)\uff08\uff09\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }
    ];
