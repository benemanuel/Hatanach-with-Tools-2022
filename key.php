...
+---+-----------+-------------+
   ...
   echo "<a target = '_blank' href='$target" . ($key+10) . "'/> ➡️</a>";
   echo "<a target = '_blank' href='$target" . ($key-10) .  "'/> ⬅️</a>";
   echo "<a target = '_blank' href='$target" . ($key-20) .  "'/> ⏪</a>";
  ...
  //echo "ספר:".show_book($sedar[3],2)." ".show_book($sedar[3],4)." סדר:".number2hebrew($sedar[1])." פיסקה:".number2hebrew($sedar[2]);echo "'></p>";
